...
<template>
    <div class="flex flex-col border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        ...
        <div v-if="title || subtitle" class="flex flex-col gap-1 p-4 pt-0">
